...
l'Hospital's Rule  :math:`\lim\limits_{n \to \infty} \frac{f(x)}{g(x)} \Rightarrow \lim\limits_{n \to \infty} \frac{f'(x)}{g'(x)}`                         
Theorem 3, pg 693  if :math:`f(n) = a_n` and :math:`\lim\limits_{n \to \infty} f(x)=L` then :math:`\lim\limits_{n \to \infty} a_n=L`                       where n is an integer; represent a sequence by a continous function
Theorem 6, pg 694  :math:`\lim\limits_{n \to \infty} | a_n | =0` then :math:`\lim\limits_{n \to \infty} a_n=0`
Theorem 7, pg 695  if :math:`\lim\limits_{n \to \infty} a_n=L` and the function f is continous at L, then :math:`\lim\limits_{n \to \infty} f(a_n)=f(L)`   use with functions like cos(), sin(), etc
...
==================== =========================================================================================================== ========================================================================================================= =================================================================================  
 Divergence          N/A                                                                                                         :math:`\lim\limits_{n\to\infty} a_n \ne 0`                                                                 Doesn't show convergence and the converse (limit goes to 0) is not true                                 
...
**Bounded Sequence**
	A sequence that is bounded from above (i.e., :math:`a_n \leq M` for all :math:`n \geq 1`) and bounded from below (i.e., :math:`a_n \geq m` for all :math:`n \geq 1`)

**Convergent**
	If :math:`\lim\limits_{n \to \infty} a_n = L` exists

**Divergent**
	If :math:`\lim\limits_{n \to \infty} a_n = L` does not exist

**Monotonic Sequence**
	A sequence that is increasing (i.e., :math:`a_n < a_{n+1}` for all :math:`n \geq 1`) or decreasing (i.e., :math:`a_n > a_{n+1}` for all :math:`n \geq 1`)
...
Copyright |copy| 2015 by Kevin Walchko. 
